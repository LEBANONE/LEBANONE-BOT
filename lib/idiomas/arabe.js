...
const smsLista1 = () => { return `🌟 معلومات YUNA-BOT 🌟`}
...
const smsLista7 = () => { return `🐈 تثبيت YUNA-BOT 🐈`}
...
//_allantilink.js
const smsTextoYT = () => { return '🐻‍❄️ ممتاز GataBot-MD - WhatsApp '}
...
const smsSoloOwner = () => { return `*يجب على مالكي تنشيط الوظيفة*\n*#on restrict*`}
...
const eGataCoins = () => { return '🐻 CumaCoins' }
